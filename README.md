...
| Tool | Experiments | Description |
| ----- | -------- | --------------------- |
| [Frequentist Inference](https://en.wikipedia.org/wiki/Frequentist_inference.ipynb) | [Example](notebooks/frequentist_ineference.ipynb) | - Simple examples of Confidence Intervals, Hypothesis Testing, and P-values. |
